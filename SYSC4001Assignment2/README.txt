----------------------------------
Assignment 2 README (Contains PseudoCode and Test Discussion)
----------------------------------
    Authors:
...
----------------------------------
    The algorithm to sort this array works as follows:
        ...
        2. Once both locks are taken by a process, it performs the switch (if necessary)
        3. The process releases both of the locks
        4. A slight wait occurs to help the process interact more smoothly
